...
import com.epam.newsmanagement.app.dao.TagRepositoryCustom;
...
public class TagRepositoryImpl implements TagRepositoryCustom {
    private static final String GET_ALL_BY_NEWS = "SELECT TAG_ID, TAG_NAME FROM TAGS " +
    ...
    @Override
    public List<Tag> getAllByNews(News news) {
        Query query = entityManager.createNativeQuery(GET_ALL_BY_NEWS, Tag.class);
